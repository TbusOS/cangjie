---
description: "Run Whetstone on the current dev session — mine transcript + git diff + pitfalls, layer L1-L4, reconcile against existing skills, write a reviewed proposal into inbox/. Trigger: 蒸馏这次 / distill this session / 把这次经验做成 skill."
---

# /distill

Execute `SKILL.md` (Phase 0 → 5) of the whetstone skill against the current session.

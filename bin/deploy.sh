#!/usr/bin/env bash
# whetstone deploy — install a skill-library pack into a target skills dir. Collision-safe.
#
...
# WHETSTONE_SKILLS_DIR) for other runtimes. Existing skills are SKIPPED unless
